namespace UserInterface.Presenters
{
    ...
    public class MainPresenter
    {
        ...
        private void PopulateStartPage(IListButtonView startPage)
        {
            ...
            startPage.AddButton(
                                "Open APSIM File",
                                          Utility.GtkUtil.CreateImage(null, "ApsimNG.Resources.Toolboxes.OpenFile.svg"),
                                          this.OnOpenApsimXFile);

            startPage.AddButton(
                                "Open an example",
                                          Utility.GtkUtil.CreateImage(null, "ApsimNG.Resources.Toolboxes.OpenExample.svg"),
                                          this.OnExample);

            startPage.AddButton(
                                "Standard toolbox",
                                          Utility.GtkUtil.CreateImage(null, "ApsimNG.Resources.Toolboxes.Toolbox.svg"),
            ...
            startPage.AddButton(
                                "Import old .apsim file",
                                          Utility.GtkUtil.CreateImage(null, "ApsimNG.Resources.Toolboxes.Import.svg"),
                                          this.OnImport);

            startPage.AddButton(
                                "Upgrade",
                                        Utility.GtkUtil.CreateImage(null, "ApsimNG.Resources.MenuImages.Upgrade.svg"),
                                        this.OnUpgrade);

            startPage.AddButton(
                                "View Cloud Jobs",
                                        Utility.GtkUtil.CreateImage(null, "ApsimNG.Resources.Cloud.svg"),
            ...
            startPage.AddButton(
                                "Settings",
                                Utility.GtkUtil.CreateImage(null, "ApsimNG.Resources.MenuImages.Settings.svg"),
                                OnShowSettingsDialog);
            startPage.AddButton(
                            "Help",
                            Utility.GtkUtil.CreateImage(null, "ApsimNG.Resources.MenuImages.Help.svg"),
                            this.OnHelp);
